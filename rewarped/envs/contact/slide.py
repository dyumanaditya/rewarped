...
class Slide(WarpEnv):
    ...
    def compute_observations(self):
        body_q = self.state.body_q.clone().view(self.num_envs, -1, 7)
        body_qd = self.state.body_qd.clone().view(self.num_envs, -1, 6)
    ...
    def render(self, state=None):
        if not self.render_traj:
            ...
            traj_vert = self.state.body_q.view(self.num_envs, -1, 7)[:, 0, :3].tolist()
